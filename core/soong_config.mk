...
$(call add_json_list, MemtagHeapAsyncExcludePaths,       $(MEMTAG_HEAP_ASYNC_EXCLUDE_PATHS) $(PRODUCT_MEMTAG_HEAP_ASYNC_EXCLUDE_PATHS) $(if $(filter true,$(PRODUCT_MEMTAG_HEAP_SKIP_DEFAULT_PATHS)),,$(PRODUCT_MEMTAG_HEAP_ASYNC_DEFAULT_EXCLUDE_PATHS)))
