...
_board_strip_readonly_list += BOARD_KERNEL_MODULES_ZIP_EXTRA_BLOCKED_16K_MODULES
...
BOARD_KERNEL_MODULES_ZIP_EXTRA_BLOCKED_16K_MODULES :=
...
BOARD_USES_RECOVERY_MEDIA :=
ifeq ($(PRODUCT_BUILD_RECOVERY_MEDIA),true)
  BOARD_USES_RECOVERY_MEDIA := true
endif
.KATI_READONLY := BOARD_USES_RECOVERY_MEDIA
